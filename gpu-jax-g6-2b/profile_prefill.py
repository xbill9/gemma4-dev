...
Run it ON the instance (it needs the GPU and the serving payload):
    ...
    systemctl stop jax-g6            # the compile wants the device to itself
    set -a; . /opt/jax-g6/env; set +a
    PYTHONPATH=/opt/jax-g6/app python3.14 profile_prefill.py \\
        --model google/gemma-4-E2B-it --sweep 512,1024,2048,4096
