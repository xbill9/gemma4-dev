# tpu-pytorch-v5e1-12b — benchmark index
...
|---|---|---|---|---|---|
| `2026-07-21-gemma4-e2b-v6e1.json` | google/gemma-4-E2B-it | tpu-v6e×1 | flex-start | ok | tpu-jax-v5e1-2b, tpu-jax-v6e1-2b, tpu-pytorch-inf2-2b, tpu-pytorch-v5e1-2b, tpu-pytorch-v6e1-2b, tpu-pytorch-v6e4-2b, tpu-vllm-v6e8-2b |
