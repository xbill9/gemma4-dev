# 🤖 Gemini Workspace Context: TPU Management Skill & tpu-pytorch-v5e1-12b MCP Agent

This workspace context file helps **Gemini Code Assistant** (and other developer tools) quickly understand the layout, goals, and integration methods of the **tpu-pytorch-v5e1-12b** project.

---

## 🎯 Project Overview & Role

This repository packages a Claude Code skill (`tpu-pytorch-v5e1-12b-management`) and a **Model Context Protocol (MCP) server** (`tpu-pytorch-v5e1-12b`) that together act as an AI DevOps/SRE agent for Google Cloud TPUs. Two main purposes:
...
- **Reference guide:** `.claude/skills/tpu-pytorch-v5e1-12b-management/references/tpu-guide.md` — TPU getting started guide: zones, quotas, troubleshooting
...
make skill-package # ...and rebuild dist/tpu-pytorch-v5e1-12b-management-skill.zip
```
