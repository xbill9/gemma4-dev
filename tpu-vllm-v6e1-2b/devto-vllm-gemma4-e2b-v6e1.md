---
title: "Serving Gemma 4 E2B on a TPU v6e-1: what Trillium buys, and what it doesn't"
published: false
series: Gemma4
tags: tpu, vllm, llm, gcp
cover_image: https://raw.githubusercontent.com/xbill9/gemma4-dev/main/tpu-vllm-v6e1-2b/v6e-cover.jpg
---
...
| HBM bandwidth | 800 GiBps | **1,638 GBps** | **1.907×** — units differ |
| Peak bf16 | 197 TFLOPs | **918 TFLOPs** | 4.66× |
| Peak Int8 | 393 TOPs | **1,836 TOPs** | 4.67× |
| TensorCores | 1 (4 MXUs, 128×128) | 1 (MXUs 256×256, count unresolved) | |
| ICI | 400 GBps bidi, 4 ports | 800 GBps bidi, 4 ports | 2.0× |
...
| **int8** | ✅ **2× bf16** | the only compute win | **still the only compute win** |
...
| ---: | ---: | :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| 128 | 1 | control | 256 | 123.3 | **202.9** | 1.65× | 202.9 | 12 ms |
| 128 | 8 | control | 2,048 | 738.3 | **1,195.1** | 1.62× | 149.4 | 26 ms |
| 1,024 | 16 | control | 18,432 | 896.1 | **1,508.0** | 1.68× | 94.2 | 149 ms |
| 4,096 | 64 | bandwidth | 270,336 | 585.9 | **1,360.0** | **2.32×** | 21.3 | 303 ms |
| 8,192 | 32 | bandwidth | 266,240 | 307.8 | **758.4** | **2.46×** | 23.7 | 348 ms |
| 8,192 | 64 | v6e_only | 532,480 | 314.4 | **870.0** | **2.77×** | 13.6 | 1,006 ms |
| 16,000 | 32 | v6e_only | 516,096 | 166.8 | **432.6** | **2.59×** | 13.5 | 3,276 ms |
| 16,000 | 64 | v6e_only | 1,032,192 | 166.7 | **446.0** | **2.68×** | 7.0 | 8,459 ms |
...
| :--- | :--- | ---: |
| working set < 10% of v5e's pool | 3 | **1.65×** |
| working set ≥ 83% of v5e's pool | 5 | **2.56×** |
...
| :--- | ---: | ---: | ---: |
| Spot | **$0.5779** | $1.4033 | 2.43× |
| Flex-start (DWS) | $0.6000 | **$1.3500** | 2.25× |
| On-demand | $1.2000 | $2.7000 | 2.25× |
...
| ---: | ---: | ---: | ---: | ---: | ---: |
| 128 | 1 | 0.1% | $1.352 | $1.848 | **1.37× dearer** |
| 128 | 8 | 0.6% | $0.226 | $0.314 | **1.39× dearer** |
| 1,024 | 16 | 6% | $0.186 | $0.249 | **1.34× dearer** |
| 4,096 | 64 | 84% | $0.284 | $0.276 | **0.97× — break-even** |
| 8,192 | 32 | 83% | $0.542 | **$0.494** | **0.91× — cheaper** |
| 16,000 | 32 | 161% | $0.999 | **$0.867** | **0.87× — cheaper** |
| 16,000 | 64 | 321% | $1.000 | **$0.841** | **0.84× — cheaper** |
| 8,192 | 64 | 166% | $0.530 | **$0.431** | **0.81× — cheaper** |
...
<!-- Fill the v5e dev.to URL below at publish time; that post is still published: false, so no
URL exists yet. The `series: Gemma4` front matter already links the two on dev.to. -->
