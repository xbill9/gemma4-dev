...
while [ $# -gt 0 ]; do
  case "$1" in
    ...
    -h|--help)
      ...
      echo "  --instance-type TYPE     g4dn.xlarge, g5g.4xlarge, g5g.8xlarge,"
      ...
      echo "                           (default: the rig directory, gpu-jax-g4dn-2b)"
...
case "$INSTANCE_TYPE" in
  g4dn.xlarge|g5g.4xlarge|g5g.8xlarge|g5g.16xlarge|g5g.metal) ;;
