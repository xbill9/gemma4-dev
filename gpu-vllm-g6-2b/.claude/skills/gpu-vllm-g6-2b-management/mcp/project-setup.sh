...
while [ $# -gt 0 ]; do
  case "$1" in
    ...
    -h|--help)
      ...
      echo "                           (g6.xlarge is ACCEPTED here: G6 has 16 GiB of host"
      ...
      echo "                           (default: the rig directory, gpu-vllm-g6-2b)"
...
# Every G6 size is accepted. The sibling rejected g5g.xlarge for having 8 GiB of
# host RAM; g6.xlarge has 16, so that rejection does not carry -- and the remedy
# for a small host is a swapfile anyway, not a bigger instance.
