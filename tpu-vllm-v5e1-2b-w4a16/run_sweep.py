...
for c in concurrencies:
    for ctx in contexts:
        ...
        try:
            ...
            cmd = f"vllm bench serve --host {VLLM_HOST} --port 8000 --model google/gemma-4-E2B-it-qat-w4a16-ct --dataset-name random --num-prompts {num_prompts} --random-input-len {ctx} --random-output-len 100 --max-concurrency {c}"
