...
The default instance name is the rig directory name, `gce-vllm-v6e8-2b`, unless `INSTANCE_NAME` is set.
...
Look for `Application startup complete.` Startup can take ~20 minutes from a cold VM. Two failure signatures
