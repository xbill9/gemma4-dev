#!/usr/bin/env bash
# Install the bundled skill and register its EC2 G5g MCP server.
set -euo pipefail
...
while [ $# -gt 0 ]; do
  case "$1" in
    ...
    -h|--help)
      ...
      echo "  --instance-type TYPE     g5g.2xlarge, g5g.4xlarge, g5g.8xlarge,"
      echo "                           g5g.16xlarge, or g5g.metal"
      echo "                           (g5g.xlarge is rejected: 8 GiB of host RAM"
      ...
      echo "                           (default: the rig directory, gpu-pytorch-g5g-2b)"
...
case "$INSTANCE_TYPE" in
  g5g.2xlarge|g5g.4xlarge|g5g.8xlarge|g5g.16xlarge|g5g.metal) ;;
  g5g.xlarge) err "g5g.xlarge has 8 GiB of host RAM; E2B needs at least 16 GiB to stage weights" ;;
