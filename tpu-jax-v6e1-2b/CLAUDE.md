...
This repository packages one Claude Code skill (`tpu-jax-v6e1-2b-management`) and one **Model Context Protocol (MCP) server** (`tpu-jax-v6e1-2b`, an MCPServer app in `server.py`). Together they:
