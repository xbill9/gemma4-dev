...
# Imported after the jax.config block above, not with the other imports: this pulls in
# jax and the model port, and the matmul-precision and compilation-cache settings must
# already be in effect when it does.
from jax_engine import GenerationStats, JaxGemmaEngine  # noqa: E402
