...
(`jax_openai_server.py`, `jax_engine.py`, `ports/gemma4/*.py`), so `deploy_torch_server` ships
...
- Instance discovery is scoped to `ManagedBy=gpu-pytorch-g5g-2b`. Never operate outside that tag.
