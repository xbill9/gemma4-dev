...
lives on exactly one EBS volume. It serves at ~31.8 tok/s. I wrote all of that up.
...
| First request 56x slower than the fourth | XLA compiling per shape bucket. Warm up before measuring. |
