...
# TPU zone/region: this rig provisions a v6e-1 through Compute Engine, whose quota is
# REGIONAL and metered separately from the Cloud TPU API. europe-west4 is where this
# project holds it. Vertex (GOOGLE_CLOUD_LOCATION above) happens to match — coincidence,
# not a dependency.
