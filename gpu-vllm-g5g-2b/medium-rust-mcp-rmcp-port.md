...
---
![](images/header-rust-mcp-rmcp.jpg)
...
(The `[RUST]` on the right is incidental here — vLLM ships its own optional Rust frontend.
This article is entirely about the `[RUST]` on the left: the agent that drives the box.)
