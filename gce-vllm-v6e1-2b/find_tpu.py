...
# Same default server.py uses for TPU_QUOTA_ID. v6e drops the "Litepod" that the v5e ids
# carry, so this does not survive a chip retarget unnoticed — it just returns nothing.
