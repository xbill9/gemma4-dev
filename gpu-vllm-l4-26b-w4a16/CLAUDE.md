# CLAUDE.md — `gpu-vllm-l4-26b-w4a16`
...
migrated measurements for **gemma-4-26B-A4B-it-qat-w4a16-ct  (see the caution below)** on an **NVIDIA L4**, and nothing else. Do not scaffold it
