...
v6e-8 (Trillium) slice — eight chips on one `ct6e-standard-8t` Compute Engine instance. The main application is a single-file FastMCP server in `server.py`. Its
